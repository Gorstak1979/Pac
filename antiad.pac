/*
    AntiAd PAC v0.8.2 (beta)
		http://sourceforge.net/projects/antiadpac

        Default set for use with BlackHole Proxy (http://s91363763.onlinehome.us/BlackHoleProxy/)
	...
	LICENSE:
		...
		The Original Code is AntiAd PAC code.
		
		The Initial Developer of the Original Code is Jakub K. Portions created by
		the Initial Developer are Copyright (C) 2006 the Initial Developer. All Rights
		Reserved.
